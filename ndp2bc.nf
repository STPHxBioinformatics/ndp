...
process bed {
	...
	publishDir "${params.outdir}02_bed_files/", mode: 'copy', pattern: '*.bed2bc'	
...
process generate_fastq {
	...
	script:
	"""
	singularity exec ${wd}0_singularity_containers/biopython1.78.sif python3 ${wd}0_scripts/extract_quality.py ${params.outdir}01_filtered_reads/ ${params.outdir}03_split_bed_files/"*_bar_*R*.bed" -o ./04_final_fastqs
	"""
}
